...
import UserOrderReturnDetailedCard from "./UserOrderReturnDetailedCard";

const UserOrderReturnCard = ({
  item,
  isArabic,
}: {
  item: Order;
  ...
  return (
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <UserOrderReturnDetailedCard itemId={item?._id} />
      </Modal>
    </>
  );
};

export default memo(UserOrderReturnCard);
