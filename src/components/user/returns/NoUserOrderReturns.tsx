    ...
    <div className="w-full min-h-[70vh] h-full flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="mt-8 mb-6 space-y-2">
        <p className="text-2xl font-bold text-gray-800">
          {t(
            "routes.user.layout.routes.returns.components.NoUserOrderReturns.empty"
          )}
        </p>

        <p className="text-sm text-gray-500">
          {t(
            "routes.user.layout.routes.returns.components.NoUserOrderReturns.advice"
          )}
        </p>
      </div>
...
export default memo(NoUserOrderReturns);
