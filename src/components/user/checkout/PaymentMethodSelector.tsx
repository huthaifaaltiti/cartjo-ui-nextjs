      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="font-semibold"> {t("card.label")}</span>
          </div>
          <p className="text-xs text-red-500 mt-1"> {t("card.unavailable")}</p>
        </button>
        ...
        >
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="font-semibold"> {t("cash.label")}</span>
          </div>
        </button>
      </div>
    </div>
