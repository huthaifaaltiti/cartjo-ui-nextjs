...
export default function PaymentForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!paymentData || !verifiedOrder) return;
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                ...
                placeholder="MM/YY"
                className="w-full px-4 py-3.5 border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none transition-colors text-lg font-mono"
                required
              />
            </div>
          ...
          <div className="mb-8">
            ...
            <input
              ...
              className="w-full px-4 py-3.5 border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none transition-colors text-lg uppercase"
              required
            />
          </div>
          ...
          <button
            ...
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white-50 font-semibold py-4 px-6 rounded-xl transition-all duration-200 disabled:from-slate-300 disabled:to-slate-400 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0"
          >
            {isProcessing ? (
              ...
              `${t("pay")} ${verifiedOrder?.amount || totalAmount.toFixed(2)} ${
