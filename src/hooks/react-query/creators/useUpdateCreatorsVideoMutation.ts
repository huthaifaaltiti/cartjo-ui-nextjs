...
export const useUpdateCreatorsVideoMutation = () => {
  ...
  return useMutation<
    ...
    UpdateCreatorsVideoPayload
  >({
    mutationFn: (payload: UpdateCreatorsVideoPayload) =>
      updateCreatorsVideo({ ...payload, lang: locale }),
